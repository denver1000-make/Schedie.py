...
from sql_orm.schedule.resolved_schedule_slots_orm import ResolvedScheduleSlotOrm
...
def schedule_g2_with_immediate_check(
    list_resolved_slots: List[ResolvedScheduleSlotOrm],
    ...
    for timeslot in list_resolved_slots:
        ...
        is_current_time_within_slot = is_time_within_timeslot(
                timeslot.day_name.lower(),
                current_day_name.lower(),
                current_time.time(),
                parsed_start_time,
                parsed_end_time
            )
